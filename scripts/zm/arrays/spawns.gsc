...
#define TRIOSPAWN_7 array(ENTRY_GATEHOUSE,7,array(ROUND(7)))
#define TRIOSPAWN_8 array(ENTRY_VOID,3,array(ROUND(7)))
#define TRIOSPAWN_9 array(ENTRY_CLOCKTOWER,6,array(ROUND(8)))
#define TRIOSPAWN_10 array(ENTRY_VOID,8,array(ROUND(8)))
#define TRIOSPAWN_11 array(ENTRY_UNDER_DRAGON,20,array(ROUND(9)))
...
#define TRIO_FIXED_SPAWNS array(TRIOSPAWN_0,TRIOSPAWN_1,TRIOSPAWN_2,TRIOSPAWN_3,TRIOSPAWN_4,TRIOSPAWN_5,TRIOSPAWN_6,TRIOSPAWN_7,TRIOSPAWN_8,TRIOSPAWN_9,TRIOSPAWN_10,TRIOSPAWN_11)
